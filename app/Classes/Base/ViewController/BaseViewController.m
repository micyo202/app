...
- (void)initialize {
     ...
     *
     * iOS11之前可使用此方法，之后使用 UIScrollView's contentInsetAdjustmentBehavior = UIScrollViewContentInsetAdjustmentNever
     */
...
- (void)setIsWhiteNavigationBar:(BOOL)isWhiteNavigationBar {
    if (isWhiteNavigationBar) {
        ...
        [self wr_setNavBarTintColor:HexColor(@"#000000", 1.f)];
